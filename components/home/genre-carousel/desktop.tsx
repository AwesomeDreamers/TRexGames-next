    ...
    <>
      {isLoading ? (
        <div className=" w-full h-auto flex items-center justify-center">
          <Skeleton className="w-[350px] h-[280px] rounded-[20px] flex-shrink-0 mx-2" />
          <Skeleton className="w-[550px] h-[350px] rounded-[30px] flex-shrink-0 mx-2" />
          <Skeleton className="w-[350px] h-[280px] rounded-[20px] flex-shrink-0 mx-2" />
        </div>
      ) : (
        <Swiper
